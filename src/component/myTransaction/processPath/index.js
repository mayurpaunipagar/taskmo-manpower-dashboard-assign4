...
export default function ProcessPath({approved,redeem}){
    ...
    <div className="processPath-container center mycol">
            <div className="center myrow">
                ...
                <img className="iconStyle"src={generateInvoice} alt="invoice icon"/>
                <div className="purpleblueText processPathTextMargin">Generate invoice</div>
                </div>
                <div className="greenLine"></div>
                
                <div className="center mycol">
                <img className="iconStyle" src={approved?approvedIcon:pendingIcon} alt="approve or pending icon"/>
                <div className={approved?`purpleblueText`:`grayText`}>{approved?`approved`:`pending`}</div>
                </div>
